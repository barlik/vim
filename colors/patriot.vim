" Vim color file
" Converted from Textmate theme Patriot using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=236 ctermbg=231 cterm=NONE guifg=#2d3133 guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=236 ctermbg=68 cterm=NONE guifg=#2d3133 guibg=#3790de gui=NONE
...
hi DiffAdd ctermfg=188 ctermbg=64 cterm=bold guifg=#cad9e3 guibg=#47850f gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0a0a guibg=NONE gui=NONE
hi DiffChange ctermfg=188 ctermbg=23 cterm=NONE guifg=#cad9e3 guibg=#273e5d gui=NONE
...
hi NonText ctermfg=59 ctermbg=59 cterm=NONE guifg=#3b3a32 guibg=#35393c gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=59 cterm=NONE guifg=#3b3a32 guibg=#3d4245 gui=NONE
