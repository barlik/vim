" Vim color file
" Converted from Textmate theme Tron Contrast using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=232 ctermbg=231 cterm=NONE guifg=#07090b guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=103 cterm=NONE guifg=NONE guibg=#7a9bc2 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#181b20 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#181b20 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#181b20 gui=NONE
hi LineNr ctermfg=60 ctermbg=16 cterm=NONE guifg=#5b6676 guibg=#181b20 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#373f49 guibg=#373f49 gui=NONE
hi MatchParen ctermfg=103 ctermbg=NONE cterm=underline guifg=#748aa6 guibg=NONE gui=underline
hi StatusLine ctermfg=146 ctermbg=59 cterm=bold guifg=#aec2e0 guibg=#373f49 gui=bold
hi StatusLineNC ctermfg=146 ctermbg=59 cterm=NONE guifg=#aec2e0 guibg=#373f49 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=103 cterm=NONE guifg=NONE guibg=#7a9bc2 gui=NONE
hi IncSearch ctermfg=232 ctermbg=81 cterm=NONE guifg=#07090b guibg=#6ee2ff gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=232 cterm=NONE guifg=#324357 guibg=#07090b gui=NONE

hi Normal ctermfg=146 ctermbg=232 cterm=NONE guifg=#aec2e0 guibg=#07090b gui=NONE
...
hi DiffAdd ctermfg=146 ctermbg=64 cterm=bold guifg=#aec2e0 guibg=#407d07 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#850202 guibg=NONE gui=NONE
hi DiffChange ctermfg=146 ctermbg=17 cterm=NONE guifg=#aec2e0 guibg=#142a49 gui=NONE
...
hi NonText ctermfg=59 ctermbg=233 cterm=NONE guifg=#3b3a32 guibg=#0f1216 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=16 cterm=NONE guifg=#3b3a32 guibg=#181b20 gui=NONE
