" Vim color file
" Converted from Textmate theme Frontier using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f2 guibg=#49850e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8e0a09 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#f8f8f2 guibg=#2b3e5a gui=NONE
