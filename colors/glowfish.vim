" Vim color file
" Converted from Textmate theme Glowfish using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=231 cterm=NONE guifg=#191f13 guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=16 ctermbg=215 cterm=NONE guifg=#191f13 guibg=#f8bb39 gui=NONE
...
hi DiffAdd ctermfg=71 ctermbg=64 cterm=bold guifg=#6ea240 guibg=#438109 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#880604 guibg=NONE gui=NONE
hi DiffChange ctermfg=71 ctermbg=23 cterm=NONE guifg=#6ea240 guibg=#1c354d gui=NONE
