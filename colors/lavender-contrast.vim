" Vim color file
" Converted from Textmate theme Lavender Contrast using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=232 ctermbg=231 cterm=NONE guifg=#080709 guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=135 cterm=NONE guifg=NONE guibg=#b657ff gui=NONE
hi CursorLine ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#1e1b20 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#1e1b20 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#1e1b20 gui=NONE
hi LineNr ctermfg=96 ctermbg=234 cterm=NONE guifg=#746b7b guibg=#1e1b20 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#47414b guibg=#47414b gui=NONE
hi MatchParen ctermfg=97 ctermbg=NONE cterm=underline guifg=#8e6da6 guibg=NONE gui=underline
hi StatusLine ctermfg=189 ctermbg=59 cterm=bold guifg=#e0ceed guibg=#47414b gui=bold
hi StatusLineNC ctermfg=189 ctermbg=59 cterm=NONE guifg=#e0ceed guibg=#47414b gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=135 cterm=NONE guifg=NONE guibg=#b657ff gui=NONE
hi IncSearch ctermfg=232 ctermbg=219 cterm=NONE guifg=#080709 guibg=#f5b0ef gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=135 ctermbg=NONE cterm=NONE guifg=#b657ff guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=232 cterm=NONE guifg=#614e6e guibg=#080709 gui=NONE

hi Normal ctermfg=189 ctermbg=232 cterm=NONE guifg=#e0ceed guibg=#080709 gui=NONE
...
hi Comment ctermfg=59 ctermbg=NONE cterm=NONE guifg=#614e6e guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=189 ctermbg=64 cterm=bold guifg=#e0ceed guibg=#407d07 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#850102 guibg=NONE gui=NONE
hi DiffChange ctermfg=189 ctermbg=17 cterm=NONE guifg=#e0ceed guibg=#142948 gui=NONE
...
hi NonText ctermfg=59 ctermbg=233 cterm=NONE guifg=#3b3a32 guibg=#131114 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=234 cterm=NONE guifg=#3b3a32 guibg=#1e1b20 gui=NONE
