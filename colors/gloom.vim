" Vim color file
" Converted from Textmate theme Gloom using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=22 ctermbg=231 cterm=NONE guifg=#2a332b guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=203 cterm=NONE guifg=NONE guibg=#ff5d38 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#3b453e gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#3b453e gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#3b453e gui=NONE
hi LineNr ctermfg=102 ctermbg=59 cterm=NONE guifg=#818f88 guibg=#3b453e gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#5c6861 guibg=#5c6861 gui=NONE
hi MatchParen ctermfg=37 ctermbg=NONE cterm=underline guifg=#26a6a6 guibg=NONE gui=underline
hi StatusLine ctermfg=188 ctermbg=59 cterm=bold guifg=#d8ebe5 guibg=#5c6861 gui=bold
hi StatusLineNC ctermfg=188 ctermbg=59 cterm=NONE guifg=#d8ebe5 guibg=#5c6861 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=203 cterm=NONE guifg=NONE guibg=#ff5d38 gui=NONE
hi IncSearch ctermfg=22 ctermbg=148 cterm=NONE guifg=#2a332b guibg=#bcd42a gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=203 ctermbg=NONE cterm=NONE guifg=#ff5d38 guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=22 cterm=NONE guifg=#4f6e64 guibg=#2a332b gui=NONE

hi Normal ctermfg=188 ctermbg=22 cterm=NONE guifg=#d8ebe5 guibg=#2a332b gui=NONE
...
hi DiffAdd ctermfg=188 ctermbg=64 cterm=bold guifg=#d8ebe5 guibg=#47850d gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0a09 guibg=NONE gui=NONE
hi DiffChange ctermfg=188 ctermbg=23 cterm=NONE guifg=#d8ebe5 guibg=#253f59 gui=NONE
...
hi NonText ctermfg=59 ctermbg=59 cterm=NONE guifg=#3b3a32 guibg=#333c34 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=59 cterm=NONE guifg=#3b3a32 guibg=#3b453e gui=NONE
