" Vim color file
" Converted from Textmate theme Peacocks In Space using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Visual ctermfg=NONE ctermbg=37 cterm=NONE guifg=NONE guibg=#26a6a6 gui=NONE
...
hi PmenuSel ctermfg=NONE ctermbg=37 cterm=NONE guifg=NONE guibg=#26a6a6 gui=NONE
...
hi PreProc ctermfg=103 ctermbg=NONE cterm=NONE guifg=#8998b9 guibg=NONE gui=NONE
