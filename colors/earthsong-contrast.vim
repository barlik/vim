" Vim color file
" Converted from Textmate theme Earthsong Contrast using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=233 ctermbg=231 cterm=NONE guifg=#12100f guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=173 cterm=NONE guifg=NONE guibg=#db784d gui=NONE
hi CursorLine ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#282320 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#282320 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#282320 gui=NONE
hi LineNr ctermfg=95 ctermbg=16 cterm=NONE guifg=#7e7163 guibg=#282320 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#514840 guibg=#514840 gui=NONE
hi MatchParen ctermfg=173 ctermbg=NONE cterm=underline guifg=#db784d guibg=NONE gui=underline
hi StatusLine ctermfg=187 ctermbg=59 cterm=bold guifg=#ebd1b7 guibg=#514840 gui=bold
hi StatusLineNC ctermfg=187 ctermbg=59 cterm=NONE guifg=#ebd1b7 guibg=#514840 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=173 cterm=NONE guifg=NONE guibg=#db784d gui=NONE
hi IncSearch ctermfg=233 ctermbg=215 cterm=NONE guifg=#12100f guibg=#f8bb39 gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=173 ctermbg=NONE cterm=NONE guifg=#db784d guibg=NONE gui=NONE
hi Folded ctermfg=95 ctermbg=233 cterm=NONE guifg=#7a7267 guibg=#12100f gui=NONE

hi Normal ctermfg=187 ctermbg=233 cterm=NONE guifg=#ebd1b7 guibg=#12100f gui=NONE
...
hi DiffAdd ctermfg=187 ctermbg=64 cterm=bold guifg=#ebd1b7 guibg=#427e08 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#870303 guibg=NONE gui=NONE
hi DiffChange ctermfg=187 ctermbg=17 cterm=NONE guifg=#ebd1b7 guibg=#192d4b gui=NONE
hi DiffText ctermfg=187 ctermbg=24 cterm=bold guifg=#ebd1b7 guibg=#204a87 gui=bold
...
hi NonText ctermfg=59 ctermbg=16 cterm=NONE guifg=#3b3a32 guibg=#1d1a17 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=16 cterm=NONE guifg=#3b3a32 guibg=#282320 gui=NONE
