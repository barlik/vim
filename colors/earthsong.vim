" Vim color file
" Converted from Textmate theme Earthsong using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=58 ctermbg=231 cterm=NONE guifg=#36312c guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=58 ctermbg=215 cterm=NONE guifg=#36312c guibg=#f8bb39 gui=NONE
...
hi DiffAdd ctermfg=187 ctermbg=64 cterm=bold guifg=#ebd1b7 guibg=#49850e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8e0a09 guibg=NONE gui=NONE
hi DiffChange ctermfg=187 ctermbg=23 cterm=NONE guifg=#ebd1b7 guibg=#2b3e5a gui=NONE
