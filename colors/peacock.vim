" Vim color file
" Converted from Textmate theme Peacock using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi IncSearch ctermfg=235 ctermbg=148 cterm=NONE guifg=#2b2a27 guibg=#bcd42a gui=NONE
...
hi PreProc ctermfg=145 ctermbg=NONE cterm=NONE guifg=#b7b1a9 guibg=NONE gui=NONE
