" Vim color file
" Converted from Textmate theme Iceberg Contrast using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=231 cterm=NONE guifg=#0b0e0e guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=31 cterm=NONE guifg=NONE guibg=#2d8da1 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1d2223 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1d2223 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1d2223 gui=NONE
hi LineNr ctermfg=60 ctermbg=16 cterm=NONE guifg=#647275 guibg=#1d2223 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#3f4849 guibg=#3f4849 gui=NONE
hi MatchParen ctermfg=153 ctermbg=NONE cterm=underline guifg=#b1e2f2 guibg=NONE gui=underline
hi StatusLine ctermfg=152 ctermbg=59 cterm=bold guifg=#bdd6db guibg=#3f4849 gui=bold
hi StatusLineNC ctermfg=152 ctermbg=59 cterm=NONE guifg=#bdd6db guibg=#3f4849 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=31 cterm=NONE guifg=NONE guibg=#2d8da1 gui=NONE
hi IncSearch ctermfg=16 ctermbg=15 cterm=NONE guifg=#0b0e0e guibg=#ffffff gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
hi Folded ctermfg=60 ctermbg=16 cterm=NONE guifg=#537178 guibg=#0b0e0e gui=NONE

hi Normal ctermfg=152 ctermbg=16 cterm=NONE guifg=#bdd6db guibg=#0b0e0e gui=NONE
hi Boolean ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
hi Character ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=152 ctermbg=64 cterm=bold guifg=#bdd6db guibg=#417e08 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#850303 guibg=NONE gui=NONE
hi DiffChange ctermfg=152 ctermbg=17 cterm=NONE guifg=#bdd6db guibg=#162c4b gui=NONE
...
hi Identifier ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
...
hi NonText ctermfg=59 ctermbg=16 cterm=NONE guifg=#3b3a32 guibg=#141818 gui=NONE
...
hi PreProc ctermfg=109 ctermbg=NONE cterm=NONE guifg=#79a2ab guibg=NONE gui=NONE
hi Special ctermfg=152 ctermbg=NONE cterm=NONE guifg=#bdd6db guibg=NONE gui=NONE
hi SpecialKey ctermfg=59 ctermbg=16 cterm=NONE guifg=#3b3a32 guibg=#1d2223 gui=NONE
hi Statement ctermfg=153 ctermbg=NONE cterm=NONE guifg=#b1e2f2 guibg=NONE gui=NONE
hi StorageClass ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
hi String ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi Tag ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
...
hi rubySymbol ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
hi rubyConstant ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=italic
...
hi rubyInclude ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
...
hi rubyEscape ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
...
hi rubyException ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
hi rubyPseudoVariable ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyRailsUserClass ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=italic
...
hi htmlSpecialChar ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
hi javaScriptFunction ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
hi javaScriptRailsFunction ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi javaScriptBraces ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi yamlKey ctermfg=74 ctermbg=NONE cterm=NONE guifg=#59c0e3 guibg=NONE gui=NONE
...
hi cssPseudoClassId ctermfg=31 ctermbg=NONE cterm=NONE guifg=#2d8da1 guibg=NONE gui=NONE
