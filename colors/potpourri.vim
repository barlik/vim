" Vim color file
" Converted from Textmate theme Potpourri using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=231 cterm=NONE guifg=#2e2b2c guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=16 ctermbg=135 cterm=NONE guifg=#2e2b2c guibg=#b866fa gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f2 guibg=#48840e gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0909 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#f8f8f2 guibg=#273b5a gui=NONE
