" Vim color file
" Converted from Textmate theme Goldfish using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=23 ctermbg=231 cterm=NONE guifg=#2e3336 guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=23 ctermbg=203 cterm=NONE guifg=#2e3336 guibg=#f36e3a gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f2 guibg=#488510 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0a0b guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#f8f8f2 guibg=#273f5f gui=NONE
