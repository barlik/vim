" Vim color file
" Converted from Textmate theme Revelation using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Folded ctermfg=95 ctermbg=16 cterm=NONE guifg=#7b726b guibg=#2e2c2b gui=NONE
