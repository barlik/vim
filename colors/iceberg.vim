" Vim color file
" Converted from Textmate theme Iceberg using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=59 ctermbg=231 cterm=NONE guifg=#323b3d guibg=#f8f8f0 gui=NONE
...
hi IncSearch ctermfg=59 ctermbg=15 cterm=NONE guifg=#323b3d guibg=#ffffff gui=NONE
...
hi DiffAdd ctermfg=152 ctermbg=64 cterm=bold guifg=#bdd6db guibg=#488711 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8d0c0c guibg=NONE gui=NONE
hi DiffChange ctermfg=152 ctermbg=23 cterm=NONE guifg=#bdd6db guibg=#294362 gui=NONE
