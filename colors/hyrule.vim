" Vim color file
" Converted from Textmate theme Hyrule using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=231 cterm=NONE guifg=#2d2c2b guibg=#f8f8f0 gui=NONE
