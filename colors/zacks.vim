" Vim color file
" Converted from Textmate theme Zacks using Coloration v0.4.0 (http://github.com/sickill/coloration)
...
hi IncSearch ctermfg=235 ctermbg=148 cterm=NONE guifg=#222222 guibg=#bcd42a gui=NONE
